  ...
  <style id="app-base-styles">
    ...
    */
    ...
    @media (min-width: 768px) {
      ...
      body.sidebar-collapsed #sidebar .sb-dropdown-toggle { padding-left: 0; padding-right: 0; justify-content: center; }
      ...
      body.sidebar-collapsed #sidebar .nav-item,
      body.sidebar-collapsed #sidebar .sb-dropdown-toggle { position: relative; }
      body.sidebar-collapsed #sidebar .nav-item:hover::after,
      body.sidebar-collapsed #sidebar .sb-dropdown-toggle:hover::after {
        content: attr(title);
        position: absolute;
        left: 100%;
        top: 50%;
      ...
      html.theme-dark body.sidebar-collapsed #sidebar .sb-dropdown-toggle:hover::after {
...
<body class="text-slate-800">
  ...
  <script id="app-runtime">
    ...
    function openModal(name, data) {
      ...
      if (name === 'add-order-wizard' || name === 'order-details' || name === 'customer-360' || name === 'add-measurement') {
