...
<div class="page bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
  <div class="px-5 py-4 border-b border-slate-200 flex gap-1.5 flex-wrap" id="notif-filter-pills">
    ...
    <span data-type="sms" data-base-class="px-3 py-1.5 rounded-md text-emerald-600 text-xs font-medium cursor-pointer hover:bg-emerald-50 transition-colors" class="px-3 py-1.5 rounded-md text-emerald-600 text-xs font-medium cursor-pointer hover:bg-emerald-50 transition-colors" onclick="setNotifFilter('sms', this)"><i class="fa-solid fa-comment-sms mr-1"></i>SMS</span>
