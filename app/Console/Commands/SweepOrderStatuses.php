...
class SweepOrderStatuses extends Command
{
    ...
    public function handle(OrderService $orders): int
    {
        ...
        // in Settings â†’ Workflow. Stages left at zero are not touched.
        $started = $orders->autoAdvanceOrders(force: true);

        // Lateness is reported, never written over the status â€” a garment can
        ...
        \App\Services\NotificationService::sweepDueOrders();
